...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "INSERT INTO orders (user_id, food, quantity, message)
            VALUES (?, ?, ?, ?)";
...
<body class="w3-container w3-padding-64 w3-yellow w3-xlarge">
...
<div class="w3-container w3-padding-64 w3-yellow w3-xlarge">
  <div class="w3-content">

    <h1 class="w3-center w3-jumbo">ORDER FOOD</h1>
  ...
  <p>
    <select class="w3-select w3-padding-16 w3-border"
            name="food"
            required>
      ...
      <option>Formaggio Pizza</option>
      <option>Chicken Pizza</option>
      <option>Pineapple O'Clock Pizza</option>
      <option>Meat Town Pizza</option>
      <option>Parma Pizza</option>

      <!-- Pasta -->
      <option>Lasagna</option>
      <option>Ravioli</option>
      <option>Spaghetti Classica</option>
      <option>Seafood Pasta</option>

      <!-- Starters -->
      <option>Today's Soup</option>
      <option>Bruschetta</option>
      <option>Garlic Bread</option>
      <option>Tomozzarella</option>
    </select>
  </p>
